...
/** @hidden */
exports.getDocument = function (element) {
    return element ? element.ownerDocument || window.document : window.document;
};
/** @hidden */
exports.getWindow = function (element) {
    var document = exports.getDocument(element);
    return document
        ? document.defaultView || window
        : window;
};
/** @hidden */
exports.scrollableRoot = function (element) {
...
/** @hidden */
exports.isScrollable = function (el) {
...
/** @hidden */
exports.getScrollableParent = function (el) {
    var root = exports.scrollableRoot(el);
    if (!el || el === document.body || el === document.documentElement) {
        return root;
    }
    var parent = el;
    while (parent && !exports.isScrollable(parent) && parent !== document.body) {
...
/** @hidden */
exports.autoScrollVelocity = function (mouseX, mouseY, rect) {
...
/** @hidden */
exports.scrollableViewPort = function (el, window) {
    var root = exports.scrollableRoot(el);
    if (el === root) {
        return {
            top: root.scrollTop,
...
/** @hidden */
exports.isPointerInsideContainer = function (x, y, container) {
