...
var AnimationChild = /** @class */ (function (_super) {
    ...
    AnimationChild.prototype.render = function () {
        ...
        var childAnimationContainerClassNames = kendo_react_common_1.classNames(className, styles['child-animation-container']);
        ...
        return (React.createElement(react_transition_group_1.CSSTransition, __assign({}, transitionProps, other), function (status) {
