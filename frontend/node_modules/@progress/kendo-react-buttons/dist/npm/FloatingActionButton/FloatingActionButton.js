...
exports.FloatingActionButton = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", __assign({ ref: elementRef, id: id || buttonId, role: items ? 'menubutton' : 'button', type: 'button', "aria-disabled": disabled, "aria-expanded": items ? open : undefined, "aria-haspopup": items ? true : false, "aria-label": (text || '') + " floatingactionbutton", "aria-owns": items ? listId : undefined, "aria-activedescendant": focusedIndex >= 0 && items ? listId + "-" + focusedIndex : undefined, tabIndex: kendo_react_common_2.getTabIndex(tabIndex, disabled), accessKey: accessKey, dir: dir, disabled: disabled, className: buttonClassNames, style: style, onClick: handleClick, onMouseDown: handleMouseDown, onFocus: handleFocus, onBlur: handleBlur, onKeyDown: handleKeyDown }, others),
            icon ?
                React.createElement("span", { role: "presentation", className: kendo_react_common_2.classNames("k-fab-icon k-icon k-i-" + icon) }) :
                iconClass ?
