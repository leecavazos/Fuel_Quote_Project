...
var LocalizationProvider = /** @class */ (function (_super) {
    ...
    LocalizationProvider.prototype.render = function () {
        var _this = this;
        return (React.createElement(GlobalizationContext_1.GlobalizationContext.Consumer, null, function (glob) { return (React.createElement(GlobalizationContext_1.GlobalizationContext.Provider, { value: __assign({}, glob, { localization: _this.getLocalizationService() }) }, _this.props.children)); }));
    };
    /**
     * @hidden
     */
