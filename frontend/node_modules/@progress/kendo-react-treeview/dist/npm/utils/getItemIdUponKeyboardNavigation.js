...
function getItemIdUponKeyboardNavigation(item, itemId, items, keyCode, fieldsSvc) {
    ...
    function getIdUponRightKey() {
        return itemUtils_1.isItemExpandedAndWithChildren(item, fieldsSvc) ? idUtils.getFirstChildId(itemId) : itemId;
    }
    ...
    function getIdUponDownKey() {
        if (itemUtils_1.isItemExpandedAndWithChildren(item, fieldsSvc)) {
    ...
    function getIdUponEndKey() {
        ...
        var children;
        while (itemUtils_1.isItemExpandedAndWithChildren(currentItem, fieldsSvc)) {
